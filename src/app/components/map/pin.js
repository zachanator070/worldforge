	...
	render(){
		...
		if(this.props.pin.page){
			pinPopupContent = <div>
				...
				{this.props.pin.page.type === 'place' && this.props.pin.page.mapImage ? <a className='margin-md-left' href='#' onClick={() => {this.props.gotoPage('/ui/map', {map: this.props.pin.page.mapImage._id})}}>Open Map</a> : null }
				{editButton}
			</div>;
		}
